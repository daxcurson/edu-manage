...
public class CursoGenerico 
{
	...
	@Column(name="abierto")
	@Type(type="ar.com.strellis.edumanage.model.CursoEstadoUserType")
	protected CursoEstado abierto;
	protected int inscriptos;
	protected int baja;
	
	/**
	 * Curso vigente, vamos a proveer una formula para calcularlo.
	 */
	@NotAudited
	@Formula("fecha_comienzo>=current_date and fecha_fin<=current_date and (baja=0 or fecha_baja<=current_date)")
