...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadDateCellHtml: function(date, colspan, otherAttrs) {
		...
		var dateFormat=date.format(this.colHeadFormat);
		if(!view.calendar.options.renderDates)
			dateFormat=date.format("dddd");
		// If I don't need to show a date, I'll replace it with an empty
		// string. The idea is to be able to show a generic calendar,
		// weekdays and all, regardless of what date it actually is.
		return '' +
