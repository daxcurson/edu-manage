...
<form:input path="inscripcionIndividual.sucursal" id="InscripcionIndividualSucursalId" />
...
<form:select path="inscripcionIndividual.idioma_estudiar" id="InscripcionIndividualIdiomaEstudiarId">
...
<form:select path="inscripcionIndividual.nivel" id="InscripcionIndividualNivelId">
...
<form:input path="inscripcionIndividual.materia" id="InscripcionIndividualMateria"/>
...
<form:select path="inscripcionIndividual.clases_semanales" id="InscripcionIndividualClasesSemanales">
...
<form:select path="inscripcionIndividual.horas_clase" id="InscripcionIndividualHorasClase">
...
<form:input path="inscripcionIndividual.fecha_comienzo" id="InscripcionIndividualFechaEstimadaComienzo"/>
...
<form:input path="inscripcionIndividual.dias_preferidos" id="InscripcionIndividualDiasPreferidos"/>
...
<form:input path="inscripcionIndividual.horario_preferido" id="InscripcionIndividualHorarioPreferido"/>
...
<form:input path="inscripcionIndividual.dias_alternativos" id="InscripcionIndividualDiasAlternativos"/>
...
<form:input path="inscripcionIndividual.horario_alternativo" id="InscripcionIndividualHorarioAlternativo"/>
...
<form:select path="inscripcionIndividual.sexo_profesor" id="InscripcionIndividualSexoProfesor">
...
<form:select path="inscripcionIndividual.preferencia_idioma" id="InscripcionIndividualPreferenciaIdioma">
...
<form:select path="inscripcionIndividual.orientacion" id="InscripcionIndividualOrientacionId">
...
<form:input path="inscripcionIndividual.cual_examen" id="InscripcionIndividualCualExamen"/>
...
<form:input path="inscripcionIndividual.otra_orientacion" id="InscripcionIndividualOtraOrientacion"/>
