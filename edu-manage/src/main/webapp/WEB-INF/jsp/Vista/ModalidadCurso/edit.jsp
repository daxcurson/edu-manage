...
<div class="panel panel-info">
	<div class="panel-heading">
		<h1 class="panel-title">Editar Modalidad de Curso</h1>
	</div>
	<div class="panel-body">
		<div class="modalidadCursos form">
		<form:form method="post" action="${pageContext.request.contextPath}/modalidad_curso/edit/${id}" commandName="modalidad_curso">
			<form:hidden path="id" />
			<tiles:insertAttribute name="form_modalidad_curso"/>
			<input type="submit" name="agregar_curso" value="Editar Modalidad">
		</form:form>
		</div>
		<div class="actions">
			<h3>Acciones</h3>
