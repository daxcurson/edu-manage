...
{
	static Logger log = Logger.getLogger(ProfesoresController.class);
	@Autowired
	...
	)
	{
		...
		List<Profesor> listaProfesores=profesorService.listarProfesoresPorPagina((current-1)*tamanoPagina, tamanoPagina);
