...
import edumanage.model.propertyeditor.IdiomaEstudiarEditor;
import edumanage.model.propertyeditor.MonedaEditor;
...
{
	static Logger log = Logger.getLogger(HonorarioProfesoresController.class);
